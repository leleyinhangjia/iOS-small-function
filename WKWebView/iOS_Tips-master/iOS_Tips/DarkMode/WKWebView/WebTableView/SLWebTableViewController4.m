...
- (void)viewDidLoad {
    ...
    [self seupUI];
    [self addKVO];
    array = [NSMutableArray arrayWithObjects:@" 方案4：(推荐) \n [UIScrollView addSubView: WKWebView & UITableView]; \n UIScrollView.contenSize = WKWebView.contenSize + UITableView.contenSize; \n WKWebView和UITableView的最大高度为一屏高，并禁用scrollEnabled=NO，然后根据UIScrollView的滑动偏移量调整WKWebView和UITableView的展示区域contenOffset。方案4：(推荐) \n [UIScrollView addSubView: WKWebView & UITableView]; \n UIScrollView.contenSize = WKWebView.contenSize + UITableView.contenSize; \n WKWebView和UITableView的最大高度为一屏高，并禁用scrollEnabled=NO，然后根据UIScrollView的滑动偏移量调整WKWebView和UITableView的展示区域contenOffset。",@" fdafldsakflsda",@" fdaflafldsakflsdafldsakflsddsakflsda",@" fdafldafldsakflsdsakflsda",@"最大高度为一屏高",@"最大高度fdsafdasfdsaffdasfdsafdasfdsafdsafsdafdsafdsafdsafdasfsdafsdafsdafdsafsd高", nil];
}
...
//        [_webView loadHTMLString:htmlString baseURL:[NSURL fileURLWithPath:[[NSBundle mainBundle] bundlePath]]];
        //http://wxkf.wdxuexi.com:8010/upload/file/202010/CourseWareFile/20201016171255287508a43ba8c855c63c68/index.pdf
        //http://wxkf.wdxuexi.com:8010/javaxieyi/show!play.do?id=202009292050292db5bfb1343d4aa5f25cea&flag=course&sid=B3231D41201FF688EE6D43422F876E25&ver=571
        //http://we.wdxuexi.com:8032/javaxieyi/show!play.do?id=20200403102458cce2e48f6811851c159f9e&flag=news&lang=zh-Hans&sid=756ACEE931C0CF8CE9FB066AC5DE6870&ver=573 图文
        //http://we.wdxuexi.com:8032/javaxieyi/show!play.do?id=202003011124194460646499e25c30480ef6&flag=course&sid=756ACEE931C0CF8CE9FB066AC5DE6870&ver=573  ppt
        
        NSURL *url = [NSURL URLWithString:@"http://we.wdxuexi.com:8032/javaxieyi/show!play.do?id=202003011124194460646499e25c30480ef6&flag=course&sid=756ACEE931C0CF8CE9FB066AC5DE6870&ver=573"];
...
- (void)updateContainerScrollViewContentSize{
    ...
    CGFloat webViewHeight = (_webViewContentHeight < (self.view.sl_height-150)) ? (_webViewContentHeight): (self.view.sl_height-150) ;
...
//    if (webViewHeight < self.view.frame.size.height) {
