...
- (void)viewDidLoad {
    ...
    XHStarRateView *starRateView2 = [[XHStarRateView alloc] initWithFrame:CGRectMake(20, 100,200, 40) numberOfStars:5 rateStyle:HalfStar isAnination:YES delegate:self];
    starRateView2.tag = 2;
    starRateView2.currentScore = 2.5;
